...
params = {
    'callback': 'jQuery31107218797606334098_1677151981710',
    'FCODE': '002190',
    'deviceid': 'embeb',
    'plat': 'Wap',
    'product': 'EFund',
...
response = requests.get('https://fundmobapi.eastmoney.com/FundMApi/FundBasicInformation.ashx', params=params, headers=headers)
print(response.url)
print(response.text)
